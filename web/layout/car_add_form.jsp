...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="author" name="model" placeholder="author">
</div>
<div class="form-group">
    <label for="press">介绍</label>
    <input type="text" class="form-control" id="press" name="describe" placeholder="press">
</div>
